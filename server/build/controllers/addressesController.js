...
var AddressController = /** @class */ (function () {
    ...
    AddressController.prototype.list = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var products;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.query("SELECT * FROM products")];
                    case 1:
                        products = _a.sent();
                        res.json(products);
                        return [2 /*return*/];
    ...
    AddressController.prototype.getOne = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, products;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, database_1.default.query("SELECT * FROM products WHERE id= ?", [
                                id
                            ])];
                    case 1:
                        products = _a.sent();
    ...
    AddressController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.query("INSERT INTO products set ?", [req.body])];
                    case 1:
                        _a.sent();
    ...
    AddressController.prototype.getByCategory = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var catId, products;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, database_1.default.query("SELECT * FROM products WHERE catId = ?", [catId])];
                    case 1:
                        products = _a.sent();
                        if (products.length > 0) {
                            return [2 /*return*/, res.json(products)];
